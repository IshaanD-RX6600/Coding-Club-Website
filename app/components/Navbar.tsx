...
const navigation = [
  ...
  { name: 'Weekly Problems', href: '/problems' },
];
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">Programming Club</span>
          </Link>
        </div>
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                ...
                <div className="py-6">
                  <Link
                    href="https://discord.gg/hgQWvpYm"
                    className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-indigo-600 hover:bg-gray-50 dark:text-indigo-400 dark:hover:bg-gray-800"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Join Discord
